        ...
        <>
            {data.map(([groupNumber, group], idx) => {
                ...
                return (
                    ...
                    <div key={groupNumber + idx} className="grid relative grid-cols-1 mb-[5vh] justify-center w-full place-items-stretch lg:place-items-center font-bold grid-rows-auto border-indigo-600 border-4 gap-2 md:gap-4 md:mb-5 items-center pb-3 bg-gradient-to-b from-zinc-200 lg:rounded-xl backdrop-blur-2xl bold overflow-hidden" >
                        ...
                        <div className={group.length > 1 ? `h-[8vh] backdrop-blur-2xl place-self-stretch flex justify-center md:justify-between items-center p-2`
                            ...
                            {group.length > 1 && <button className="hidden md:block h-[25px] w-[25px] md:w-[40px]" onClick={() => HorizontalScroll(scrollId, false)}>
